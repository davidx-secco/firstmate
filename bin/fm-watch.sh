...
# overrides them; the UNSCOPED fallback set is owned fleet-wide by
# bin/fm-composer-lib.sh (FM_COMPOSER_BUSY_REGEX_DEFAULT), so extend it there when
# a new adapter is verified.
# claude/codex: "esc to interrupt"; opencode: "esc interrupt"; pi: "Working...";
# grok: "Ctrl+c:cancel"; Cursor Agent: "ctrl+c to stop". Claude's current spinner
# signature is matched only for a recorded Claude task because an ellipsis
