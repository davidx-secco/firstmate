...
# hand-edit backlog files too, primary config/herdr-presentation-spaces enables
# the same default-off Herdr presentation projection, and primary
# config/gh-accounts gives that home's workers the same owner-to-GitHub-account
# mapping). It also pushes
...
FM_INHERITABLE_CONFIG="${FM_INHERITABLE_CONFIG:-crew-dispatch.json crew-harness backlog-backend herdr-presentation-spaces gh-accounts}"
