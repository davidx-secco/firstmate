...
The verified primary harnesses are `claude`, `codex`, `opencode`, `pi`, `pi-signed`, `grok`, and `kimi`; `cursor` is verified only for crewmate and scout dispatch, never as a primary or secondmate harness.
