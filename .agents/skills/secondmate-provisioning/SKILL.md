...
The `config/crew-harness` step skips a crewmate/scout-only harness (muse) instead of inheriting it, with a loud reason; `docs/configuration.md` owns the details.
