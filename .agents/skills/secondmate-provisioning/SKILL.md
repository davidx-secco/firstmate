...
The `config/crew-harness` step skips a crewmate/scout-only harness (cursor) instead of inheriting it, with a loud reason; `docs/configuration.md` owns the details.
